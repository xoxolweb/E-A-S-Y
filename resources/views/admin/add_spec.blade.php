...
@section('content')
    ...
    <form action="{{route('adminStoreSpec')}}" method="post" enctype="multipart/form-data" >
            <div class="row">
                @if (count($errors) > 0)
        ...
        {{--<label for="photo">Фото</label></label><input type="file" accept="image/*" id="photo" name="photo">--}}
                    <div class="col-md-5">
                        ...
                        <input id="images" type="file" name="photo" multiple accept="image/*" class="btn btn-default">
